...
public class Intermediary {
    public static ArrayList<IField> getList(final Figure figure, final IPotentialBasicPatterns basicAttackPatterns) {
        ...
        if (Bishop.class.equals(figure.getClass()) || BishopExtended.class.equals(figure.getClass())) {
            return basicAttackPatterns.getDiagonalFields(figure);

        } else if (Queen.class.equals(figure.getClass()) || QueenExtended.class.equals(figure.getClass())) {
            list.addAll(basicAttackPatterns.getDiagonalFields(figure));
            list.addAll(basicAttackPatterns.getHorizonVerticalFields(figure));
            return list;

        } else if (Pawn.class.equals(figure.getClass()) || PawnExtended.class.equals(figure.getClass())) {
            return basicAttackPatterns.getPawnFields(figure);

        } else if (Rook.class.equals(figure.getClass()) || RookExtended.class.equals(figure.getClass())) {
            return basicAttackPatterns.getHorizonVerticalFields(figure);

        } else if (King.class.equals(figure.getClass()) || KingExtended.class.equals(figure.getClass())) {
            return basicAttackPatterns.getKingFields(figure);

        } else if (Knight.class.equals(figure.getClass()) || KnightExtended.class.equals(figure.getClass())) {
